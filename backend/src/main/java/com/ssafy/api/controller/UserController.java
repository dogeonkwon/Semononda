...
public class UserController {
	...
	public ResponseEntity<UserResponse> idOverlapCheck(@RequestBody @ApiParam(value="로그인 정보", required = true) UserLoginPostReq loginInfo) {
...
//		return ResponseEntity.status(401).body(UserLoginPostRes.of(401, "Invalid Password", null));
	...
	public ResponseEntity<UserResponse> nicknameOverlapCheck(@RequestBody @ApiParam(value="넥네임 정보", required = true) UserLoginPostReq loginInfo) {
