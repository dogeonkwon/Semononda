...
public class UserController {
	...
	public ResponseEntity<UserResponse> idOverlapCheck( @ApiParam(value="아이디 정보", required = true) @RequestParam("user_id")String id) {
...
//		return ResponseEntity.status(401).body(UserLoginPostRes.of(401, "Invalid Password", null));
	...
	public ResponseEntity<UserResponse> getUserInfo( @ApiParam(value="아이디 정보", required = true) @RequestParam("id")String id) {
